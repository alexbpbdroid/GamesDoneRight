      ...
      <div className="wishlist-outer">
        <div className="wishlist-inner">
          ...
          <div className="wishlist-games">
            {games.map((game) => (
              <div className="wishlist-single-game-outer" key={game.id}>
                <Link to={`/games/${game.id}`} className="wishlist-single-game">
                ...
                <div id="wishlist-delete-price-id" className="wishlist-delete-price">
